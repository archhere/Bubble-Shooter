...
var init = function init(level) {
  ...
  for (var i = 0; i < level.countofbubbles; i++) {
    ...
    bubbleArray.push(new Bubbles(randomIntFromRange(20, canvas.width - 20), 20, randomIntFromRange(0.1, 2), randomIntFromRange(-2, 2), randomIntFromRange(5, 8), randomColor(colors)));
  }
};
